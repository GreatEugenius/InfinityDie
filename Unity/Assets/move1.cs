...
public class Move1 : MonoBehaviour
{
    ...
    void run()
    {
        ...
        animator.SetBool("isRunRight", Input.GetKey(KeyCode.LeftArrow) && Input.GetKey(KeyCode.RightShift));
        animator.SetBool("isRunLeft", Input.GetKey(KeyCode.RightArrow) && Input.GetKey(KeyCode.RightShift));
    }
